...
impl Circle {
    ...
    // (not explicitly required by the Shape trait)
}
...
impl Triangle {
    ...
    fn new(base: f64, height: f64, name: &'static str) -> Self {
        Triangle {
            base,
            height,
            name,
...
pub fn run3() {
    ...
    let triangle1 = Triangle::new(4.0, 5.0, "Triangle1");
    let triangle2 = Triangle::new(3.0, 3.0, "Triangle2");

    // Compare circles based on perimeter
    let circle_result = circle1.perimeter().partial_cmp(&circle2.perimeter());
    println!("Circle perimeter comparison result: {:?}", circle_result);

    // Compare triangles based on perimeter
    let triangle_result = triangle1.perimeter().partial_cmp(&triangle2.perimeter());
    println!("Triangle perimeter comparison result: {:?}", triangle_result);
}
